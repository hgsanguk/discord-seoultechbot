...
class DiscordServer(Base):
    ...
    Attributes:
        ...
        # channel_id_notice_colleage_단과대학이름: Discord 서버 내에서 각 단과대학 알림을 받을 채팅 채널의 id입니다.
        # channel_id_notice_department_단과대학이름: Discord 서버 내에서 각 학과 알림을 받을 채팅 채널의 id입니다.
    """
